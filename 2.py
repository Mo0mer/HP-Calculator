...
name = Label(root, textvariable=nametext, fg="#000000", bg="#FFC697", font='Times 14')  # Имя героя(текст)
hpout = Label(root, textvariable=hptext, fg="#000000", bg="#FFC697", font='Times 14')  # Хп героя(текст)
kdout = Label(root, textvariable=kdtext, fg="#000000", bg="#FFC697", font='Times 14')  # Кд героя(текст)
...
fzgame = Label(root, textvariable=fzgamet, fg="#000000", bg="#FFC697", font='Times 14')  # Фаза игры
...
elnab = Button(root, text='Доб.хар.', font='Times 11', bg="#FF9842", fg='#000000', command=elnabf)
