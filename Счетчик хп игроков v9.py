...
elnab = Button(root, text='Доб.хар.', font='Times 11', fg='#20B2AA', command=elnabf)
soprdmg = Button(root1, text='Доб.сопр', font='Times 11', fg='#20B2AA', command=soprf)
uizdmg = Button(root1, text='Доб.уязв', font='Times 11', fg='#20B2AA', command=uizf)
dpdmg = Button(root1, text='Доб.урон', font='Times 11', fg='#20B2AA', command=dpdmg)
